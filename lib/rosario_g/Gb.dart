...
class Gb extends StatefulWidget{
  const Gb({Key key}) : super(key: key);

  @override
  _GbState createState() => _GbState();
}

class _GbState extends State<Gb> {
  ...
  Widget build(BuildContext context) {
    ...
    String image = 'ae.jpg';
    String rutasiguiente = '/Gc';
    String titulo = 'Ave Maria para aumentar la Fe';
    String contenido = 'Dios te salve, María, Virgen '
        'Purísima antes del parto; en tus manos ponemos nuestra fe para que la '
        'ilumines, llena eres de gracia; el Señor '
