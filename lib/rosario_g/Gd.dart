...
class _GdState extends State<Gd> {
  ...
  Widget build(BuildContext context) {
    ...
    String image = 'ac.jpg';
    String rutasiguiente = '/Ge';
    String titulo = 'Ave Maria para aumentar la Caridad';
    String contenido = 'Dios te salve, María, Virgen Purísima después del '
        'parto, en tus manos ponemos nuestra caridad para que la inflames; '
