...
class Ge extends StatefulWidget{
  ...
  @override
  _GeState createState() => _GeState();
}

class _GeState extends State<Ge> {
  ...
  Widget build(BuildContext context) {
    ...
    String image = 'ab.jpg';
    String rutasiguiente = '/Gf';
    String titulo = 'Oración de la Salve';
    String contenido = 'Dios te Salve, María, Templo, Trono y '
        'Sagrario de la Santísima Trinidad, Virgen concebida sin la culpa '
        'Original.\n\n'
        ...
        'este valle de lágrimas. Ea, pues, Señora, abogada nuestra, vuelve a '
        'nosotros esos tus ojos misericordiosos; y después de este destierro '
        'muéstranos a Jesús, fruto bendito de tu vientre. ¡Oh clementísima, oh '
        'piadosa, oh dulce siempre Virgen María! Ruega por nosotros, Santa '
