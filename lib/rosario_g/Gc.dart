...
class Gc extends StatefulWidget{
  const Gc({Key key}) : super(key: key);

  @override
  _GcState createState() => _GcState();
}
...
class _GcState extends State<Gc> {
  ...
  Widget build(BuildContext context) {
    ...
    String image = 'ad.jpg';
    String rutasiguiente = '/Gd';
    String titulo = 'Ave Maria para aumentar la Esperanza';
    String contenido = 'Dios te salve, María, Virgen Purísima en el parto, en '
        'tus manos ponemos nuestra esperanza para que la alientes; llena eres '
        'de gracia; el Señor '
