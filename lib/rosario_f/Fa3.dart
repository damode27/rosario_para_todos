...
class Fa3 extends StatefulWidget{
  const Fa3({Key key}) : super(key: key);

  @override
  _Fa3State createState() => _Fa3State();
}

class _Fa3State extends State<Fa3> {
  ...
  Widget build(BuildContext context) {
    ...
    String image = 'fa.jpg';
    String rutasiguiente = '/Fb';
    String titulo = 'Padre Nuestro';
    String contenido = 'Padre nuestro, que estás en el cielo, santificado sea '
