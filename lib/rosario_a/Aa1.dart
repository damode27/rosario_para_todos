...
class Aa1 extends StatefulWidget{
  const Aa1({Key key}) : super(key: key);

  @override
  _Aa1State createState() => _Aa1State();
}
...
class _Aa1State extends State<Aa1> {
  ...
  Widget build(BuildContext context) {
    ...
    String image = 'aa.jpg';
    String rutasiguiente = '/Aa2';
    String titulo = 'Credo de los Apóstoles';
    String contenido = 'Creo en Dios, Padre todopoderoso, creador del cielo y de la tierra. Creo en Jesucristo, su único Hijo, '
    'nuestro Señor, que fue concebido por obra y gracia del Espíritu Santo, nació de santa '
    ...
    'vivos y muertos. Creo en el Espíritu Santo, la santa iglesia católica, la comunión de los '
