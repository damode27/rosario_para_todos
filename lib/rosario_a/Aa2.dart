...
class Aa2 extends StatefulWidget{
  const Aa2({Key key}) : super(key: key);

  @override
  _Aa2State createState() => _Aa2State();
}

class _Aa2State extends State<Aa2> {
  ...
  Widget build(BuildContext context) {
    ...
    String image = 'aa.jpg';
    String rutasiguiente = '/Ba1';
    String titulo = 'Acto de contrición';
    String contenido = 'Señor mío Jesucristo, Dios y Hombre verdadero, Creador, '
        'Padre y Redentor mío; por ser vos quien sois, bondad infinita, y '
        ...
        'infierno. Ayudado de vuestra divina gracia, propongo firmemente nunca '
