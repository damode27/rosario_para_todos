...
class Da1 extends StatefulWidget{
  const Da1({Key key}) : super(key: key);

  @override
  _Da1State createState() => _Da1State();
}

class _Da1State extends State<Da1> {
  ...
  Widget build(BuildContext context) {
    ...
    String image = 'da.jpg';
    String rutasiguiente = '/Da2';
    String titulo = 'Oración de Fátima';
    String contenido = 'Oh Jesús, perdónanos nuestros pecados, sálvanos del fuego del infierno '
        'y guía todas las almas al Cielo, especialmente aquellas que necesitan '
        'más de tu misericordias. Amén.\n\n\n'
        '(Adicionalmente puede decir más Jaculatorias).';
