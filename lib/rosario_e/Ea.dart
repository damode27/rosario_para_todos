...
class Ea extends StatefulWidget{
  const Ea({Key key}) : super(key: key);

  @override
  _EaState createState() => _EaState();
}
...
class _EaState extends State<Ea> {
  ...
  Widget build(BuildContext context) {
    ...
    String image = 'ea.jpg';
    String rutasiguiente = '/Ea1';
    String titulo = 'Gloria';
    String contenido = 'Gloria al Padre, y al Hijo, y al Espíritu Santo. \n\n'
