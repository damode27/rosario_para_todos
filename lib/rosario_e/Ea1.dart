...
class Ea1 extends StatefulWidget{
  const Ea1({Key key}) : super(key: key);

  @override
  _Ea1State createState() => _Ea1State();
}

class _Ea1State extends State<Ea1> {
